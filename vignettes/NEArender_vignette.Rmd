...
```{r include=F, echo=F}
packages <- c("NEArender","data.table","graphics")
...
# General workflow {#test1}
![Implementation of NEArender \label{figlab0}](system.file("extdata","img","aa.png",package="NEArender"))
...
connectivity(NET="http://research.scilifelab.se/andrej_alexeyenko/downloads/test_data/merged6_and_wir1_HC2", Lowercase = 1, col.1 = 1, col.2 = 2, echo=1, main="Higher order topology")
```
...
topology2nd(NET="http://research.scilifelab.se/andrej_alexeyenko/downloads/test_data/merged6_and_wir1_HC2", Lowercase = 1, col.1 = 1, col.2 = 2, echo=1, main="Higher order topology")
```
